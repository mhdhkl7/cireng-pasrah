...
<style>
    ...
    .btn-save:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(14,165,233,0.4); }
...
<div class="profil-layout">
    ...
    <div class="profil-sidebar">
        ...
        <div class="profil-role">👤 Customer</div>
                ...
                <form method="POST" action="{{ route('profil.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" id="address" class="form-control" rows="3"
                                  placeholder="Alamat untuk pengiriman Anda">{{ old('address', $user->address) }}</textarea>
        ...
        <div class="section-card">
            ...
            <div class="section-body">
                <form method="POST" action="{{ route('profil.password') }}">
                    ...
                    <button type="submit" class="btn-save" style="background:linear-gradient(135deg,#ef4444,#dc2626);box-shadow:0 4px 15px rgba(239,68,68,0.3);">
                        🔑 Ganti Password
                    </button>
                </form>
            </div>
